...
//   },
// };
export const categories: Record<string, { name: string; model: string }> = {
  "1": { name: "Gadjetlar", model: "GadgetProduct" },
  "2": { name: "Maishiy texnika", model: "MaishiyTexnikaProduct" },
  "3": { name: "Kiyim-kechak", model: "KiyimProduct" },
  "4": { name: "Oziq-ovqat", model: "FoodProduct" },
  "5": { name: "Qurilish va ta’mirlash", model: "QurilishProduct" },
  "6": { name: "Aksessuarlar", model: "AksessuarProduct" },
  "7": { name: "Salomatlik", model: "SalomatlikProduct" },
  "8": { name: "Uy-ro‘zg‘or buyumlari", model: "UyBuyumProduct" },
  "9": { name: "Kanselyariya", model: "KanselyariyaProduct" },
};