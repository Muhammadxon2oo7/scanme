          ...
          >
            ...
            <CardContent className="p-4 space-y-4 bg-white/90">
              {section.questions.map((question) => {
                ...
                // Faqat editable uchun value ni tozalash (myId ga teng bo'lsa)
                const value = isEditable && rawValue === myId ? "" : rawValue;

                // Placeholder faqat editable uchun maxsus logika
                ...
                if (isEditable) {
                  ...
                  } else if (notification.status === "sent" && !value) {
