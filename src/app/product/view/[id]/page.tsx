...
export default function ProductDetailsPage(): JSX.Element {
  ...
  //     await submitRating(newRating, productID);
  ...
  try {
    ...
    // ✅ 1. Foydalanuvchining bahosi local holatda ko‘rinadi
    setProductData(prev => prev ? { ...prev, user_rating: newRating } : prev);

    // ✅ 2. Backenddan yangilangan ma'lumotni qayta olib kelamiz
    ...
    setProductData({
      ...
      rating: updated.rating || 0, // o‘rtacha baho ham yangilanadi
