  ...
  const collaborationRequests: CollaborationRequest[] = [
    {
      ...
      message: "Bizning mahsulotimiz uchun ekran moduli ishlab chiqarishda ta'minotchi lik qilmoqchimiz.",
      status: "pending",
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground">ta'minotchi  tashkilotlar bilan ishlashni boshqaring</p>
        </div>
        <Button className="scan-button" onClick={() => setIsRequestDialogOpen(true)}>
          <Plus className="mr-2 h-4 w-4" />
          ta'minotchi lik Taklifi
        </Button>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <Card className="p-4 bg-card/50 backdrop-blur-sm border-border/50">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm text-muted-foreground">Faol ta'minotchi lar</p>
        ...
        <Card className="p-4 bg-card/50 backdrop-blur-sm border-border/50">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm text-muted-foreground">Jami ta'minotchi lar</p>
        ...
        <TabsContent value="collaborators" className="space-y-6">
          <Card className="p-4 bg-card/50 backdrop-blur-sm border-border/50">
            <div className="relative">
              ...
              <Input
                placeholder="ta'minotchi  nomi yoki STIR raqami bo'yicha qidiring..."
                value={searchQuery}
