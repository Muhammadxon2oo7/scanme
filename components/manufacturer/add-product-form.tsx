    ...
    <form onSubmit={handleSubmit} className="space-y-8">
      ...
      <div className="space-y-6">
        ...
        <Alert>
          ...
          <AlertDescription>
            Agar mahsulotingiz bir nechta tashkilot tomonidan ishlab chiqarilgan bo'lsa, hamkor tashkilotlarni qo'shing.
        ...
        <Card className="p-4 bg-background/30">
          <h3 className="font-medium mb-4">Yangi Hamkor Qo'shish</h3>
        ...
        {collaborators.length > 0 && (
          <div className="space-y-3">
            <h3 className="font-medium">Qo'shilgan Hamkorlar</h3>
